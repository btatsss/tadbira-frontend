  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.card}>
        ...
        <h1 style={s.heading}>إعادة تعيين كلمة المرور</h1>
        <p style={s.lede}>أدخل كلمة المرور الجديدة</p>

        {error && <div style={s.errorBox}>{error}</div>}
        {success && <div style={s.successBox}>تم تغيير كلمة المرور بنجاح، جارٍ تحويلك...</div>}
...
const s: Record<string, React.CSSProperties> = {
  ...
  heading: { fontFamily: '"Cormorant Garamond", serif', fontWeight: 500, fontSize: "28px", color: "#fff", margin: "0 0 8px" },
  lede: { color: "#9aa7bd", fontSize: "14px", margin: "0 0 28px" },
  ...
  successBox: { background: "rgba(74,222,128,.08)", border: "1px solid rgba(74,222,128,.25)", borderRadius: "8px", padding: "16px", color: "#4ade80", fontSize: "13.5px" },
